function getTodaysImage() {
    fetch("https://api.nasa.gov/planetary/apod?api_key=RiNiqUQOfSlECOZWWkdZBhoDCEFK3HnKqokWIqw8")
    .then((res) => res.json())
    .then(function(res) {
  ...
  function getSpecificImage() {
    ...
    fetch(`https://api.nasa.gov/planetary/apod?api_key=RiNiqUQOfSlECOZWWkdZBhoDCEFK3HnKqokWIqw8&date=${date}`)
    .then((res) => res.json())
    .then(function(res) {
